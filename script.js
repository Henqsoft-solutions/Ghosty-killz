...
playButton.addEventListener("click", ()=>{
    ...
    swal.fire({
        ...
        text: "Swipe up, left, right, down to jump, stop, run, sit respectively. You can also click to shoot.",
        icon: "info",
    });
...
//Handle the width of the canvas if canvas is resized
...
//                running.pause();
            ...
            //Reset the maximum number of cycling of the spritesheet according to the player state
